...
public class UpdateAdmin extends javax.swing.JFrame {
    ...
    public UpdateAdmin(int Admin_ID) {
        initComponents();
        admin_ID = Admin_ID;
        EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        admin = (Admin) em.createNamedQuery("Admin.findByAdminID").setParameter("adminID", admin_ID).getSingleResult();
        txtAdminID.setText(admin.getAdminID().toString());
        txtPassword.setText(admin.getPassword());
        txtFirstName.setText(admin.getAdminFName());
        txtLastName.setText(admin.getAdminLName());
        cmbPayTitle.setSelectedItem(admin.getTitle());
        cmbSchoolID.setSelectedItem(admin.getSchoolID());
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        if (txtAdminID.getText().equals("") || txtFirstName.getText().equals("") || txtLastName.getText().equals("") || txtConformPass.getText().equals("") || txtPassword.getText().equals("") || cmbPayTitle.getSelectedItem().toString().equals("") || cmbSchoolID.getSelectedItem().toString().equals("")) {
            ...
            try {
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                admin = em.find(Admin.class, admin_ID);
                em.getTransaction().begin();
                ...
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "Administrator is Updated.", "Warning", 1);
            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(null, "Your input data maybe wrong format.", "Warning", 1);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Something get wrong Please try sometime.", "Warning", 1);
            }
        }
