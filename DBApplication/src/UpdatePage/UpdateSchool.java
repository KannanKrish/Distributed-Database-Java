 ...
 * @author Kannan
 */
public class UpdateSchool extends javax.swing.JFrame {
    ...
    public UpdateSchool(int schoolID) {
        initComponents();
        this.schoolID = schoolID;
        EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        school = (Schools) em.createNamedQuery("Schools.findBySchoolID").setParameter("schoolID", schoolID).getSingleResult();
        txtSchoolID.setText(school.getSchoolID().toString());
        txtSchoolName.setText(school.getSchoolName());
        txtSchoolType.setText(school.getSchoolType());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (txtSchoolName.getText().equals("") || txtSchoolID.getText().equals("") || txtSchoolType.getText().equals("")) {
            ...
            try {
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                school = em.find(Schools.class, schoolID);
                em.getTransaction().begin();
                ...
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "School is updated successfully.", "Warning", 1);
            } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSchool.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateSchool().setVisible(true);
            }
        });
    }
