...
public class UpdateDepartment extends javax.swing.JFrame {
    ...
    public UpdateDepartment(int departNo) {
        initComponents();
        this.departNo = departNo;
        EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        depart = (Departments) em.createNamedQuery("Departments.findByDeptID").setParameter("deptID", departNo).getSingleResult();
        txtDepartNo.setText(depart.getDeptID().toString());
        txtDepartName.setText(depart.getDeptName());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (txtDepartName.getText().equals("") || txtDepartNo.getText().equals("")) {
            ...
            try {
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                depart = em.find(Departments.class, departNo);
                em.getTransaction().begin();
                depart.setDeptID(Integer.parseInt(txtDepartNo.getText()));
                depart.setDeptName(txtDepartName.getText());
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "Department is Updated successfully.", "Warning", 1);
            } catch (Exception ex) {
