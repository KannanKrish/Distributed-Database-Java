 ...
 * @author Kannan
 */
public class UpdateClassRooms extends javax.swing.JFrame {
    ...
    public UpdateClassRooms(int classRoomNo) {
        initComponents();
        this.classRoomNo = classRoomNo;
        EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        classRooms = (ClassRooms) em.createNamedQuery("ClassRooms.findByClassRoomNumber").setParameter("classRoomNumber", classRoomNo).getSingleResult();
        txtClassRoomNo.setText(classRooms.getClassRoomNumber().toString());
        cmbClassID.setSelectedItem(classRooms.getClassNO().toString());
        cmbSchoolID.setSelectedItem(classRooms.getSchoolID().toString());
    ...
    private void initComponents() {
        ...
        txtClassRoomNo.setEditable(false);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (txtClassRoomNo.getText().equals("") || cmbClassID.getSelectedItem().toString().equals("") || cmbSchoolID.getSelectedItem().toString().equals("")) {
            ...
            try {
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                classRooms = em.find(ClassRooms.class, classRoomNo);
                em.getTransaction().begin();
                classRooms.setClassRoomNumber(Integer.parseInt(txtClassRoomNo.getText()));
                classRooms.setClassNO(new Classes(Integer.parseInt(cmbClassID.getSelectedItem().toString())));
                classRooms.setSchoolID(new Schools(Integer.parseInt(cmbSchoolID.getSelectedItem().toString())));
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "ClassRoom is Updated successfully.", "Warning", 1);
            } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateClassRooms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateClassRooms().setVisible(true);
            }
        });
    }
