...
import managePages.OfficesManage;

/**
 *
 * @author Kannan
 */
public class UpdateOffice extends javax.swing.JFrame {
    ...
    public UpdateOffice(int tacherID) {
        initComponents();
        ...
        office = (Offices) em.createNamedQuery("Offices.findByTacherID").setParameter("tacherID", tacherID).getSingleResult();
        SimpleDateFormat format = new SimpleDateFormat("hh:mm:ss");
        txtHours.setText(format.format(office.getOfficehours()));
        txtOfficeNO.setText(office.getOfficeNO().toString());
        txtTeacherID.setText(office.getTacherID().toString());
        cmbDepartmentID.setSelectedItem(office.getDepartID());
        cmbSchoolID.setSelectedItem(office.getSchoolID());
    ...
    private void initComponents() {
        ...
        departmentsQuery = java.beans.Beans.isDesignTime() ? null : DBApplicationPUEntityManager0.createQuery("SELECT d FROM Departments d");
        ...
        jLabel7.setText("Select Department ID :");

        eLProperty = org.jdesktop.beansbinding.ELProperty.create("${resultList}");
        jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, departmentsQuery, eLProperty, cmbDepartmentID);
        bindingGroup.addBinding(jComboBoxBinding);
        ...
        txtHours.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("hh:mm:ss"))));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cmbDepartmentID, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cmbSchoolID, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(jLabel1)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtTeacherID, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtOfficeNO, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txtOfficeNO, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (txtTeacherID.getText().equals("") || txtOfficeNO.getText().equals("") || txtHours.getText().equals("") || cmbDepartmentID.getSelectedItem().toString().equals("") || cmbSchoolID.getSelectedItem().toString().equals("")) {
            JOptionPane.showMessageDialog(null, "Some field's are missing.", "Warning", 1);
        } else {
            try {
                SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss");
                String beginDate = "01/01/2000 " + txtHours.getText();
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                office = em.find(Offices.class, tacherID);
                em.getTransaction().begin();
                office.setDepartID(new Departments(Integer.parseInt(cmbDepartmentID.getSelectedItem().toString())));
                office.setOfficeNO(Integer.parseInt(txtOfficeNO.getText()));
                office.setOfficehours(format.parse(beginDate));
                office.setSchoolID(new Schools(Integer.parseInt(cmbSchoolID.getSelectedItem().toString())));
                office.setTacherID(Integer.parseInt(txtTeacherID.getText()));
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "Office is Updated to database.", "Warning", 1);
            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(null, "Your input data maybe wrong format.", "Warning", 1);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Check the Office Information already exists.", "Warning", 1);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateOffice().setVisible(true);
            }
        });
    }
    ...
    private java.util.List<EntityClasses.Departments> departmentsList;
