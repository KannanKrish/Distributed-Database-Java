 ...
 * @author Kannan
 */
public class InsertOffice extends javax.swing.JFrame {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        if (txtTeacherID.getText().equals("") || txtOfficeNO.getText().equals("") || txtHours.getText().equals("") || cmbDepartmentID.getSelectedItem().toString().equals("") || cmbSchoolID.getSelectedItem().toString().equals("")) {
            ...
            try {
                ...
                DBManager.persist(office);
                JOptionPane.showMessageDialog(null, "Office is added to database.", "Warning", 1);
            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(null, "Your input data maybe wrong format.", "Warning", 1);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Check the Office already exists.", "Warning", 1);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertOffice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertOffice().setVisible(true);
            }
        });
    }
