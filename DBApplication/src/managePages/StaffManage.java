...
import UpdatePage.UpdateStaff;
import insertPages.InsertStaff;
...
public class StaffManage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        staffQuery = java.beans.Beans.isDesignTime() ? null : DBApplicationPUEntityManager.createQuery("SELECT s FROM Staff s");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${staffFName}"));
        columnBinding.setColumnName("Staff FName");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${staffLName}"));
        columnBinding.setColumnName("Staff LName");
        columnBinding.setColumnClass(String.class);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                new UpdateStaff(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString())).show();
                dispose();
            }
        } catch (Exception ex) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                String staffID = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                em.getTransaction().begin();
                Staff staff = (Staff) em.createNamedQuery("Staff.findByStaffID").setParameter("staffID", Integer.parseInt(staffID)).getSingleResult();
                em.remove(staff);
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "The selected staff is deleted from Database.", "Warning", 1);
                refreshTable();
            } else {
    ...
    private java.util.List<EntityClasses.Staff> staffList;
