...
import UpdatePage.UpdateStudent;
import insertPages.InsertStudent;
...
public class StudentsManage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${emergancyPhone}"));
        columnBinding.setColumnName("Emergancy Phone");
        columnBinding.setColumnClass(Integer.class);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                new UpdateStudent(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString())).show();
                dispose();
            }
        } catch (Exception ex) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                ...
                Students student = (Students) em.createNamedQuery("Students.findByStudentID").setParameter("studentID", Integer.parseInt(studentID)).getSingleResult();
                em.remove(student);
