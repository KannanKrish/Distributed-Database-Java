...
import UpdatePage.UpdateDepartment;
import insertPages.InsertDepartment;
...
public class DepartmentManage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        departmentsQuery = java.beans.Beans.isDesignTime() ? null : DBApplicationPUEntityManager.createQuery("SELECT d FROM Departments d");
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${deptID}"));
        columnBinding.setColumnName("Dept ID");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                new UpdateDepartment(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString())).show();
                dispose();
            }
        } catch (Exception ex) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                String depart_ID = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                em.getTransaction().begin();
                Departments departments = (Departments) em.createNamedQuery("Departments.findByDeptID").setParameter("deptID", Integer.parseInt(depart_ID)).getSingleResult();
                em.remove(departments);
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "The Department is deleted from Database.", "Warning", 1);
                refreshTable();
            } else {
