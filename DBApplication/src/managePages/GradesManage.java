...
import UpdatePage.UpdateGrades;
 ...
 * @author Kannan
 */
public class GradesManage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gradesQuery = java.beans.Beans.isDesignTime() ? null : DBApplicationPUEntityManager.createQuery("SELECT g FROM Grades g");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, gradesList, jTable1);
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${classes}"));
        columnBinding.setColumnName("Classes");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${mark}"));
        columnBinding.setColumnName("Mark");
        columnBinding.setColumnClass(Integer.class);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                new UpdateGrades(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString())).show();
                dispose();
            }
        } catch (Exception ex) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                ...
                Grades grade = (Grades) em.createNamedQuery("Grades.findByStdudentID").setParameter("studentID", Integer.parseInt(studentID)).getSingleResult();
                em.remove(grade);
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "The Grade is deleted from Database.", "Warning", 1);
                refreshTable();
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GradesManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GradesManage().setVisible(true);
            }
        });
    }
    ...
    private java.util.List<EntityClasses.Grades> gradesList;
