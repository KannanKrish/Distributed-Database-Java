...
import UpdatePage.UpdateSchool;
import insertPages.InsertSchool;
 ...
 * @author Kannan
 */
public class SchoolsManage extends javax.swing.JFrame {

    /**
     * Creates new form AdminManage
     */
    public SchoolsManage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, schoolsList, jTable1);
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${schoolName}"));
        columnBinding.setColumnName("School Name");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${schoolType}"));
        columnBinding.setColumnName("School Type");
        columnBinding.setColumnClass(String.class);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                new UpdateSchool(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString())).show();
                dispose();
            }
        } catch (Exception ex) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().equals("")) {
                String schoolID = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
                EntityManagerFactory emf = javax.persistence.Persistence.createEntityManagerFactory("DBApplicationPU");
                EntityManager em = emf.createEntityManager();
                em.getTransaction().begin();
                Schools school = (Schools) em.createNamedQuery("Schools.findBySchoolID").setParameter("schoolID", Integer.parseInt(schoolID)).getSingleResult();
                em.remove(school);
                em.getTransaction().commit();
                JOptionPane.showMessageDialog(null, "The selected School is deleted from Database.", "Warning", 1);
                refreshTable();
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SchoolsManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SchoolsManage().setVisible(true);
            }
        });
    }
